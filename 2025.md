...
| Time             | Speaker / Authors (Affiliation)                               | Contant                                                       |
|-----------------:|:--------------------------------------------------------------|:--------------------------------------------------------------|
| 8:30-9:00        |                                                                     |  **Coffee and Registration**                               |
| 9:00-9:10        | Suren Byna                                                          |CHEOPS Welcome                                        |
| 9:10-10:00       | **Keynote - Gustavo Alonso (ETH Zurich, Switzerland)**              | **TBD**                                              |
...
| 11:00-11:30      | Krijn Doekemeijer (Delft University of Technology), Joost Hoozemans (Voltron Data), Zaid Al-Ars (Delft University of Technology)                                                         | GSST: Parallel string decompression at 191 GB/s on GPU                                                     |
...
| 12:00-12:30      | **Invited talk - Jean-Thomas Acquaviva (DDN France)**                | From HPC to AI: A Data Journey                       |
