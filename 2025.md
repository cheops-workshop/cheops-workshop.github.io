...
| 9:10-10:00       | **Keynote - [Gustavo Alonso](https://people.inf.ethz.ch/alonso/) (ETH Zurich, Switzerland)**              | **Vertically integrated storage systems**            |
...
| 12:00-12:30      | **Invited talk - [Jean-Thomas Acquaviva](https://dblp.org/pid/56/6206.html) (DDN Storage)**                | From HPC to AI: A Data Journey                       |
...
##### Abstract
Scalable and Efficient Big Data Processing in Clouds: Addressing Performance Variability

##### Bio
Shadi Ibrahim is an Inria research scientist within the Magellan team. His current research interests are in scalable data management, storage systems, data-intensive computing, parallel I/O and distributed file systems, virtualization technology and Cloud/Fog/Edge computing. 
